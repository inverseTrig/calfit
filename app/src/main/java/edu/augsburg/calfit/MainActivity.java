...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            fragmentManager.beginTransaction().replace(R.id.content_frame, new GroceryFragment()).commit();
        } else if (id == R.id.nav_exercise) {
            fragmentManager.beginTransaction().replace(R.id.content_frame, new ExerciseFragment()).commit();
